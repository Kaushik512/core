$(function() {
    ...
    function createAppCard(data) {
        ...
        $appCard.find('.appCardBuildBtn').data('applicationId',data._id).click(function(e) {
            ...
            $modal.modal('show');
            $.get('../organizations/' + urlParams.org + '/businessgroups/' + urlParams.bg + '/projects/' + urlParams.projid + '/applications/'+applicationId+'/build', function(data) {
    ...
    $('.appCardSaveBtn').click(function(e) {
        ...
        /*
    var fd = new FormData();
    fd.append("applicationIcon", iconFileInput[0]);
    ...
    $('.actionnewControlPanel').click(function(e) {
        ...
        if ($selectedCard.length) {
            window.location.href = 'index.html#ajax/newControlpanel.html';
        }
    });
