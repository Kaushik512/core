                                          ...
                                          $divinstancescardview.append($item);
                                                                      ...
                                                                      $.get('/cloudformation/'+stackId+'/status', function(msg) {
                                                                          switch (stack.status) {
                                                                              case 'CREATE_IN_PROGRESS':
                                                                                  ...
                                                                                  break;
                                                                              case 'CREATE_FAILED':
                                                                                  $('[data-stackId=' + stackId + ']').find('.stackStatus').append('CREATE_FAILED').css({
                                                                                      'color': 'red'
                                                                                  });
                                                                                  break;
                                                                              case 'CREATE_COMPLETE':
                                                                                  $('[data-stackId=' + stackId + ']').find('.stackStatus').append('CREATE_COMPLETE').css({
                                                                                      'color': 'green'
                                                                                  });
                                                                                  break;
                                                                              default:
                                                                                  $('[data-stackId=' + stackId + ']').find('.stackStatus').append(stack.status).css({
                                                                                      'color': 'yellow'
                                                                                  });
                                                                                  return;
                                                                          }
                                                                  ...
                                                                  function addStackToDom(stack) {
                                                                      ...
                                                                      $clonedDiv.find('.stackStatus').append(stack.status);
