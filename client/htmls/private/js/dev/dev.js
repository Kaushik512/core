...
else
{
 bootbox.alert('Please select an instance to remove.');
    ...
    $(document).ready(function(){   
      /*********************************Instance.js********************/
/*
This is the entry method for initialising the instance Stuff in Dev.html.
*/
...
/*
Attach Click Event on IP Address Import, which will reset instance form.
*/
...
/*
Attaching Click event on instances tab which will set BreadCrum for Instances
*/
...
//$(function() {
      ...
      /*    function removeSelectedBlueprint(data) {
