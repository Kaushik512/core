$('#ribbon')
    .append(
        '<div class="demo"><span id="demo-setting"><i class="fa fa-cog txt-color-lightwhite"></i></span> <form><legend class="no-padding margin-bottom-10">Layout Options</legend><section><label><input name="subscription" id="smart-fixed-nav" type="checkbox" class="checkbox style-0"><span>Fixed header</span></label><label><input type="checkbox" name="terms" id="smart-fixed-ribbon" class="checkbox style-0"><span>Fixed Ribbon</span></label><label><input type="checkbox" name="terms" id="smart-fixed-navigation" class="checkbox style-0"><span>Fixed Navigation</span></label><label style="display:none;"><input type="checkbox" name="terms" id="smart-rtl" class="checkbox style-0"><span>Right to left <b>(rtl)</b></span></label> <span id="smart-bgimages"></span></section> <h6 class="margin-top-10 semi-bold margin-bottom-5">Catalyst Themes</h6><section id="smart-styles"><a href="javascript:void(0);" id="smart-style-2" data-skinlogo="img/version2_22.png" class="btn btn-xs btn-block txt-color-darken margin-top-5" style="background:#fff;">DevOps Default</a><a href="javascript:void(0);" id="smart-style-1" data-skinlogo="img/version2_22.png" class="btn btn-block btn-xs txt-color-white" style="background:#fcc227;">DevOps Yellow</a><a href="javascript:void(0);" id="smart-style-0"  data-skinlogo="img/Black-catalyst.png" class="btn btn-block btn-xs txt-color-white margin-right-5" style="background-color:#4E463F;"></i>DevOps Brown</a><a href="javascript:void(0);" id="smart-style-3" data-skinlogo="img/version2_22.png" class="btn btn-xs btn-block txt-color-darken margin-top-5" style="background:#438eb9;">DevOps Blue</a><a href="javascript:void(0);" id="smart-style-4" data-skinlogo="img/version2_22.png" class="btn btn-xs btn-block txt-color-darken margin-top-5" style="background:#b50400;">DevOps Red</a></section></form> </div>'
)
//<label><input type="checkbox" name="terms" id="smart-fixed-container" class="checkbox style-0"><span>Inside <b>.container</b> <div class="font-xs text-right">(non-responsive)</div></span></label>
// hide bg options
var smartbgimage =
