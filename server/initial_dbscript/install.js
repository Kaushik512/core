...
var orgData = {
    "orgname": "Phoenix",
    "domainname": "www.phoenix.org",
    "rowid": "46d1da9a-d927-41dc-8e9e-7e926d927537",
    "id": "1",
    "__v": 0,
    "active": true
};
var orgModel = new d4dModelNew.d4dModelMastersOrg(orgData);
orgModel.save(function(err, anOrg) {
    if (err) {
        logger.debug("Failed to save Org.");
        return;
    }
    logger.debug("Auto created Org successful. ");
});
...
var buData = {
    ...
    "rowid": "7e3500f1-58f9-43e2-b9eb-347b2e4d129d",
    "id": "2",
    "__v": 0,
    "active": true
};
var buModel = new d4dModelNew.d4dModelMastersProductGroup(buData);
buModel.save(function(err, anBu) {
    if (err) {
        logger.debug("Failed to save BU.");
        return;
    }
    logger.debug("Auto created BU successful. ");
});
...
var projData = {
    ...
    "description": "PhoenixApp",
    "orgname": "Phoenix",
    "orgname_rowid": "46d1da9a-d927-41dc-8e9e-7e926d927537",
    "productgroupname": "PhoenixBG",
    "productgroupname_rowid": "7e3500f1-58f9-43e2-b9eb-347b2e4d129d",
    "environmentname": "",
    "environmentname_rowid": "",
    "rowid": "b38ccedc-da2c-4e2c-a278-c66333564719",
    "id": "4",
    "__v": 0,
    "active": true
};
var projModel = new d4dModelNew.d4dModelMastersProjects(projData);
projModel.save(function(err, proj) {
    if (err) {
        logger.debug("Failed to save Project.");
        return;
    }
    logger.debug("Auto created Project successful. ");
});
