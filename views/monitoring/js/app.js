	...
	if ($.fn.sparkline) {
		...
		$('.sparkline').each(function() {
			...
			if (sparklineType == 'pie') {
				...
				var pieColors = $this.data('sparkline-piecolor') || ["yellow", "red", "#98AA56", "#da532c", "#6E9461", "#0099c6", "#990099", "#717D8A"], pieWidthHeight = $this.data('sparkline-piesize') || 90, pieBorderColor = $this.data('border-color') || '#45494c', pieOffset = $this.data('sparkline-offset') || 0;
